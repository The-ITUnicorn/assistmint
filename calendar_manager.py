...
def check_calendar(date="today", week=False, specific_week_start=None):
    ...
    if week:
        ...
        if date.lower() == "this week":
            start_date = datetime.now() - timedelta(days=datetime.now().weekday())  # Monday of this week
            end_date = start_date + timedelta(days=6)
        elif date.lower() == "next week":
            start_date = datetime.now() + timedelta(days=(7 - datetime.now().weekday()))  # Monday of next week
            end_date = start_date + timedelta(days=6)
        elif specific_week_start:
            start_date = datetime.strptime(specific_week_start, "%d %b %Y")
            end_date = start_date + timedelta(days=6)
        else:
